...
import { getWorkflowPhaseDetails } from "@/server/workflows/getWorkflowPhaseDetails";
...
function ExecutionViewer({ initialData }: { initialData: ExecutionData }) {
  ...
  // update the view every second to visualize changes / the progress
  ...
  useEffect(() => {
    // while running we auto select the current running phase
    // in the sidebar
  ...
  return (
    <div className="flex w-full h-full">
      <aside className="flex flex-grow flex-col border-separate border-r-2 w-[440px] min-w-[440px] max-w-[440px] overflow-hidden">
      ...
      <div className="flex w-full h-full">
        {isRunning && (
          <div className="w-full h-full flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-muted-foreground text-sm fon-bold">
...
function ExecutionLabel({
  ...
  return (
    <div className="flex justify-between items-center py-2 px-4 text-sm">
      ...
      <div className="font-semibold captialize flex gap-2 items-center">
        {value}
      </div>
    </div>
  );
